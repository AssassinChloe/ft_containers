...
/*   Updated: 2022/06/03 13:52:11 by cassassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    std::stack<int, std::vector<int> > testvect;
    std::stack<int, std::list<int> > testlist;
    std::stack<int, std::deque<int> > testdeq;
    ...
    std::stack<int, std::vector<int> > testvect2;
    std::stack<int, std::list<int> > testlist2;
    std::stack<int, std::deque<int> > testdeq2;
